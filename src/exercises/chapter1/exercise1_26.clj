(ns exercises.chapter1.exercise1_26)
...
;“I do.” says Eva. “By writing the procedure like that, you have transformed the Θ(log n) process into a
;  Θ(n) process.”
;Explain.

; ANSWER: It calls expmod recursively two times, instead of once. As the results of both calls are needed to
;   compute the multiplication, it turns expmod into a tree recursion.
