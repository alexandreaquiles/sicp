(ns exercises.chapter2.exercise2_19)

; Exercise 2.19:
; Consider the change-counting program of Section 1.2.2.
; It would be nice to be able to easily change the currency used by the program, so that we could compute
...
;   than an integer specifying which coins to use.
...
; The order doesn't affect the answer because cc computes all possible combinations.
