...
;I need an abstraction that comes from math
...
(euclidean-distance (make-point 3 10) (make-point 3 15))
; => 5.000023178253949

(euclidean-distance (make-point 3 15) (make-point 5 15))
; => 2.0000000929222947

(defn segment-length [segment]
  (euclidean-distance (start-segment segment) (end-segment segment)))

(segment-length (make-segment (make-point 3 10) (make-point 3 15)))
; => 5.000023178253949
